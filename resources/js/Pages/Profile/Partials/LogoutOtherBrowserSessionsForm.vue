...
<template>
    <div class="space-y-8 px-4 sm:px-0">
      ...
      <div class="text-center mb-2">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full mb-4 shadow-lg">
          <span class="text-2xl text-white">🌐</span>
        </div>
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Sesi Browser Aktif</h1>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-500/10 to-amber-500/10 py-4 px-2 border-b border-orange-100">
          <div class="text-center">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Pantau Keamanan Sesi Kita</h2>
        ...
        <div class="p-4">
          <!-- Information Section -->
          <div class="mb-4 p-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
            <p class="text-gray-700 leading-relaxed flex items-start gap-3">
          ...
          <div v-if="sessions.length > 0" class="mt-2 space-y-2">
            <div 
              ...
              :key="i" 
              class="flex items-center p-2 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300"
            >
              <!-- Device Icon -->
              <div class="flex-shrink-0 mr-4">
                <div class="w-12 h-12 bg-gradient-to-r from-orange-100 to-amber-100 rounded-xl flex items-center justify-center border border-orange-200">
                  <span class="text-2xl">{{ getDeviceIcon(session) }}</span>
                </div>
              </div>
              ...
              <div v-if="session.is_current_device" class="flex-shrink-0 ml-4">
          ...
          <div v-else class="text-center py-8">
            ...
            <p class="text-gray-500 text-lg">Tidak ada sesi browser lain yang aktif</p>
            <p class="text-gray-400 text-sm mt-2">Semua sesi saat ini aman dan terkendali</p>
          </div>
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <button
              @click="confirmLogout"
              class="px-6 py-3 rounded-2xl font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 active:scale-95"
    ...
    <div v-if="confirmingLogout" class="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-3xl max-w-md w-full shadow-2xl border border-white/50 overflow-hidden">
        <!-- Modal Header -->
        <div class="bg-gradient-to-r from-red-500/10 to-orange-500/10 py-6 px-4 border-b border-red-100">
          <div class="text-center">
            <div class="w-16 h-16 bg-gradient-to-r from-red-400 to-orange-400 rounded-full flex items-center justify-center mx-auto mb-4">
              <span class="text-2xl text-white">⚠️</span>
            </div>
            <h3 class="text-xl font-bold text-gray-800">Konfirmasi Keluar Sesi</h3>
        ...
        <div class="p-4">
          <div class="mb-4">
            <p class="text-gray-700 text-sm leading-relaxed flex items-start gap-3">
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              <input
                ...
                type="password"
                class="w-full border border-gray-200 rounded-2xl p-2 pl-12 focus:ring-2 focus:ring-red-300 focus:border-red-300 transition-all duration-300 bg-white/50 backdrop-blur-sm"
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 border-t border-gray-200">
          <button
            @click="closeModal"
            class="px-6 py-2 rounded-2xl font-medium transition-all duration-300 border border-gray-300 hover:bg-gray-50 text-gray-700"
          ...
          <button
            ...
            class="px-6 py-2 rounded-2xl font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl"
